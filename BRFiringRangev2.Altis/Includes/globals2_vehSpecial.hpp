...
BR_DamageHandler =
{ 
	private ["_unitInVehicle", "_dmgDelta", "_isSniper" ,"_resultValue","_priorDamageValue","_knownProjectileModifier","_dmgMultiplierHead","_dmgMultiplierNeck","_dmgMultiplierBody","_dmgMultiplierHands","_dmgMultiplierLegs","_dmgMultiplierOverall","_isExplosiveRound"];
	...
	{ 
		case 0:
		{
			...
			diag_log format["[H] Sel:(face %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		};
		case 1:
		{
			...
			diag_log format["[H] Sel:(Neck %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		}; 			
		case 2:
		{
			_priorDamageValue = _unit getHitIndex 2; // Head
			_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierHead * _knownProjectileModifier); 
			diag_log format["[H] Sel:(Head %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		};
		case 3:
		{
			...
			diag_log format["[H] Sel:(Pelvis %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		}; 
		case 4:
		{
			_priorDamageValue = _unit getHitIndex 4; //spine1
			_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierBody * _knownProjectileModifier); 
			diag_log format["[H] Sel:(spine1 %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		};  
		case 5:
		{
			_priorDamageValue = _unit getHitIndex 5; //spine2
			_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierBody * _knownProjectileModifier); 
			diag_log format["[H] Sel:(spine2 %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		};  
		case 6:
		{
			_priorDamageValue = _unit getHitIndex 6;	//spine3
			_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierBody * _knownProjectileModifier); 
			diag_log format["[H] Sel:(spine3 %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		};			
		case 7:
		{
			_priorDamageValue = _unit getHitIndex 7; // Body
			_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierBody * _knownProjectileModifier); 
			diag_log format["[H] Sel:(Body %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		}; 
		case 8:
		{
			...
			diag_log format["[H] Sel:(Arms %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		};  
		case 9:
		{
			_priorDamageValue = _unit getHitIndex 9; // Hands
			_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierHands * _knownProjectileModifier); 
			diag_log format["[H] Sel:(Hands %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		}; 
		case 10:
		{
			...
			diag_log format["[H] Sel:(Legs %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue];
		}; 
		case -1:
		{
			_priorDamageValue = damage _unit;		
			diag_log format["[H] Sel:(ALL START %1) 		PriorDmg:%2 	EngineProposed:%3", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue];

			// If sniper ammo, you dead.
			if (_isSniper) then
			{
				diag_log "[H]  		-- Detected sniper.";
				_resultValue = _priorDamageValue + ((_engineProposedDamageValue - _priorDamageValue) * _dmgMultiplierOverall);
			} 
			else
			{
				diag_log "[H]  		-- NOT sniper.";

				_overallMultiplierForThisHit = _dmgMultiplierOverall;
				_unitInVehicle = !(vehicle _unit == _unit);

				if (diag_tickTime - br_lastBulletTime < 0.1 && !_unitInVehicle) then
				{
					diag_log "[H]  		-- SAME bullet.";
					...
					if (br_thisBulletOverallDamage + _dmgDelta >= br_maxOverallDamagePerBullet) then
					{
						diag_log "[H]  		-- Detected delta + overallBullet > max allowed per bullet.  Only allowing damage to limit.";
						//_resultValue = _priorDamageValue + (br_maxOverallDamagePerBullet - br_thisBulletOverallDamage);
					...
					{
						diag_log "[H]	-- Detected delta + overallBullet < max allowed.  OK.  Keeping original result value.";
				...
				else
				{
					if (!_unitInVehicle) then 
					{
						...
						{
							diag_log "[H]	-- Detected massive hit delta > limit per bullet.  This can still kill.";
							_resultValue = _priorDamageValue + br_maxOverallDamagePerBullet;
						} 
						else
						{
							diag_log "[H]	-- Detected hit < limit. Keeping original result value.";
						};
						br_thisBulletOverallDamage = 0 + _resultValue;
					}
					else
					{
						diag_log "[H]  		-- In Vehicle";
						br_lastBulletTime = diag_tickTime;
						br_thisBulletOverallDamage = 0;
						br_thisBulletStartingHealth = _priorDamageValue;
						...
						_dmgDelta = abs (_priorDamageValue - _resultValue);
							...
							diag_log "[H]	-- Since player in car, allow all damage!";
			...
			diag_log format["[H] Sel:(ALL END %1) 		PriorDmg:%2 	EngineProposed:%3 	_resultValue=%4 	br_thisBulletOverallDamage=%5", _hitPartIndex, _priorDamageValue, _engineProposedDamageValue, _resultValue, br_thisBulletOverallDamage];
		};
		default{ };
	};
